    ...
    <div class="container">
        <form action="{{ route('teacher.exam.store') }}" method="POST" enctype="multipart/form-data">
            ...
            @foreach($questions as $question)
                ...
                <div class="form-group">
                    <input type="radio"  name="answer" value="{{ \App\Models\Question::A }}">{{ $question->answer_A }}
                    <input type="radio"  name="answer" value="{{ \App\Models\Question::B }}"> {{ $question->answer_B }}
                    <input type="radio"  name="answer" value="{{ \App\Models\Question::C }}">{{ $question->answer_C }}
                    <input type="radio"  name="answer" value="{{ \App\Models\Question::D }}">{{ $question->answer_D }}
